...
#if 1
const static NTX_FW_LM3630FL_RGBW_current_item E70Q02A2_FL_RGBW_cur_tab[] = {
#include "e70q02a2_kobo_RGBW_FL_curr_table_20160914.h"
};
static NTX_FW_LM3630FL_RGBW_current_item *gptLm3630fl_RGBW_RicohCurrTab = E70Q02A2_FL_RGBW_cur_tab;
static unsigned long gdwLm3630fl_RGBW_RicohCurrTabItems = sizeof(E70Q02A2_FL_RGBW_cur_tab)/sizeof(E70Q02A2_FL_RGBW_cur_tab[0]);
int lm3630a_set_FL_RGBW_RicohCurrTab(unsigned long I_dwRGBW_curr_items,void *I_pvLm3630fl_RGBW_curr_tab) {return 0;}
#else 
